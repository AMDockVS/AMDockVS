...
def main() -> int:
    ...
    from amdockvs.project.sets import list_molecule_set_ids
    ...
    try:
        ...
        run_id = "smoke_run"
        job_id = runtime.diversity.cluster_job(
        ...
        runtime.diversity.register_run_from_sidecar(
            run_id, method="bitbirch_lean", threshold=0.45, scope_label="smoke", fp_radius=2, fp_nbits=2048
        )
        saved = runtime.diversity.load_clustering_result(run_id)
        ...
        analysis = runtime.diversity.analyze(method="bitbirch_lean", threshold=0.45)
        ...
        sampled = runtime.diversity.analyze(method="bitbirch_lean", threshold=0.5, sample_limit=4)
        ...
        ref = runtime.diversity.save_centroids_as_set(run_id, name="smoke_centroids")
