...
from amdockvs.workflows.orchestrator import STEP_NEEDS_CONFIG, STEP_PENDING, WorkflowStep
...
_NO_ARG: dict[str, tuple[str, str, Submit]] = {
    ...
    "diversity_selection": ("Diversity selection (BitBIRCH)", "descriptors", lambda rt: rt.diversity.cluster_job()),
}
