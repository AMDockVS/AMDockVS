...
def saved_theme_name(default: str = "auto") -> str:
    ...
    """
    from amdockvs.core.configuration import THEME_NAME_PATH, create_amdock_configuration
...
def saved_base_font_pt(default: float = DEFAULT_FONT_PT) -> float:
    ...
    """
    from amdockvs.core.configuration import FONT_BASE_PT_PATH, create_amdock_configuration
